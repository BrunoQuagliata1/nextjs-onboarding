  ...
  return (
    <footer className=" bottom-0 w-full px-5 py-2.5">
      ...
      <div className="flex h-5 items-center justify-between ">
        <p className="text-gray-custom text-xs leading-6">info@planit.com.uy</p>
        <p className="text-gray-custom text-right text-xs leading-6">
          Tel: +598 96593615
        </p>
      </div>
      <hr className="my-2.5" />
      <div className="flex justify-between gap-5">
        <div className="text-gray-custom text-xs leading-6">
